<article id="<?php the_id(); ?>" <?php post_class('post'); ?>>
	...
	<?php 
	$video_host_type = rwmb_meta( 'futura_video_host_type', $args = array('type' => 'radio'), $post->ID );
	$video_self_hosted = rwmb_meta( 'futura_shvideo', $args = array('type' => 'file_advanced'), $post->ID );
	if ($video_host_type =='embeded'): ?>
	<div class="featured-media">
		<?php echo rwmb_meta( 'futura_video_embed_code', $args = array('type' => 'textarea'), $post->ID ); ?>
	</div>
